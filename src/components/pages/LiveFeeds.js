        ...
        <Row>
          <Col sm={12} lg={6} className="category__content">
            ...
            <div className="category__text">
              <p>
                We all are very busy especially in the 21st century. With all
                these distractions around us staying productive can be
                incredible hard. There is always another email another text or
                another meeting. In the rush of the moment we tend to forget
                that being busy and being productive are two completely
                different things. In this category I will share some of the
                productivity hacks that I use and how you can implement them in
                your life as well.
              </p>
            </div>
          </Col>
